CREATE TABLE [etl].[ProdCopy_Transaction__c]
(
...
[Seat_Block__c] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[ETLLoad] [datetime] NULL CONSTRAINT [DF__ProdCopy___ETLLo__6AEFE058] DEFAULT (getdate())
)
GO

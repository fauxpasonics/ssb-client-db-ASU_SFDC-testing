...
CREATE PROCEDURE [api].[GETSTHAccountViewFB16] AS 
BEGIN
           ...
           , STH.SectionInfoPrev AS [F15_Sections]
           , STH.SectionInfoCur AS [F16_Sections]
           , STH.PrevYrSoldQty AS [Sold_Qty_2015]
           , STH.CurYrSoldQty AS [Sold_Qty_2016]
           ...
           from [172.31.17.15].[ASUTIF1].[dbo].[vwTISTHAccountViewFB16] STH
           ...
           FOR XML PATH('ASU2016SeasonTicketAccount'), ROOT('ASU2016SeasonTicketAccounts')

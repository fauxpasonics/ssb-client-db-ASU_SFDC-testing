...
--INSERT INTO dbo.[CD_ProcessQueue]
--SELECT 'TI_ASU', Patron, 'PrimaryAddress' contactfield, GETDATE() FROM dbo.[Patron__c] a 
--WHERE LTRIM(a.[PrimaryAddressStreet]) <> LTRIM(a.[CD_PrimaryAddress] + ' ' + [a].[CD_PrimaryAddressSuite])

...
BEGIN
	...
	SELECT @SourceTable = SourceTable 
		...
		,@mergeProc = mergeproc
	FROM ASU.dbo.SourceExtractControl
	WHERE Source = @Source
	...
	begin
		...
		INSERT INTO dbo.AuditSourceExtract (BatchId, Source, IntegrationName, SourceTable, DestinationTable, IncrementalExtractDate, ExecStartDate, FullLoad)
